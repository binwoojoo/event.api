...
public class EventUserService {
    ...
    public boolean checkEmailDuplicate(String email) {
        ...
        // 중복이 아니면 선제적으로 회원가입을 시킴(데이터베이스 처리, 이메일 보내는 것...)
    ...
    public String sendVerificationEmail(String email) {
        ...
        try {
            ...
            // 이메일 제목 설정
            mimeMessageHelper.setSubject("[인증메일] 중앙정보스터디 가입 인증 메일");
            // 이메일 내용 설정
            mimeMessageHelper.setText("인증 코드: <b style=\"font-weight: 700; letter-spacing: 5px; font-size: 30px;\">" + code + "</b>",
                    true);
    ...
    // 검증 코드 생성 로직 1000~9999 사이의 숫자 4자리
